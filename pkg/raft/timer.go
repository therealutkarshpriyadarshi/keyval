...
// HeartbeatTimer represents a periodic heartbeat timer for leaders
...
// C returns the channel that receives heartbeat ticks
func (h *HeartbeatTimer) C() <-chan time.Time {
	return h.c
}
